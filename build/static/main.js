...
!function (t) {
  ...
  var r = e(1),
    ...
    for (f in v && (e = n), e) {
      l = ((s = !h && m && void 0 !== m[f]) ? m : e)[f], p = g && s ? c(l, r) : y && "function" == typeof l ? c(Function.call, l) : l, m && u(m, f, l, t & a.U), x[f] != l && i(x, f, p), y && w[f] != l && (w[f] = l);
    }
  };
  ...
  t.exports = function (t, n) {
    ...
    return function (n, c, v) {
      for (var d, y, g = i(n), m = o(g), x = r(c, v, 3), w = u(m.length), b = 0, S = e ? h(n, w) : a ? h(n, 0) : void 0; w > b; b++) {
  ...
  if (e(8)) {
    var r = e(31),
      ...
      return !(Bt(t, n = m(n, !0)) && b(e) && x(e, "value")) || x(e, "get") || x(e, "set") || e.configurable || x(e, "writable") && !e.writable || x(e, "enumerable") && !e.enumerable ? W(t, n, e) : (t[n] = e.value, t);
    };
    ...
    h(Wt, Ct), p(Wt, vt, Ct.values), h(Wt, {
      ...
      x ? (v = e(function (t, e, r, o) {
        ...
        if (b(e)) {
          if (!(e instanceof Y || "ArrayBuffer" == (a = w(e)) || "SharedArrayBuffer" == a)) return xt in e ? Mt(v, e) : Tt.call(v, e);
          i = e, h = _t(r, n);
          var g = e.byteLength;
          ...
          } else if ((u = d(o) * n) + h > g) throw q("Wrong length!");
        ...
        var i;
        return s(t, v, f), b(e) ? e instanceof Y || "ArrayBuffer" == (i = w(e)) || "SharedArrayBuffer" == i ? void 0 !== o ? new g(e, _t(r, n), o) : void 0 !== r ? new g(e, _t(r, n)) : new g(e) : xt in e ? Mt(v, e) : Tt.call(v, e) : new g(y(e));
      ...
      var M = E[vt],
          ...
          T = Ct.values;
      p(v, yt, !0), p(E, xt, f), p(E, wt, !0), p(E, gt, v), (a ? new v(1)[dt] == f : dt in E) || W(E, dt, {
        get: function get() {
          return f;
        }
        ...
        from: Tt,
        of: At
      }), "BYTES_PER_ELEMENT" in E || p(E, "BYTES_PER_ELEMENT", n), u(u.P, f, Rt), k(f), u(u.P + u.F * Et, f, {
        set: kt
      }), u(u.P + u.F * !j, f, Ct), r || E.toString == pt || (E.toString = pt), u(u.P + u.F * i(function () {
        new v(1).slice();
      }), f, {
        slice: Nt
  ...
  t.exports = function (t, n, e, d, y, g) {
    ...
    if ("function" == typeof x && (g || b.forEach && !l(function () {
      ...
      })).prototype = b, b.constructor = x), (F || M) && (E("delete"), E("has"), y && E("get")), (M || O) && E(w), g && b.clear && delete b.clear;
    } else x = d.getConstructor(n, t, y, w), u(x.prototype, e), c.NEED = !0;

    return h(x, t), S[t] = x, o(o.G + o.W + o.F * (x != m), S), g || d.setStrong(x, t, y), x;
  };
}, function (t, n, e) {
  for (var r, o = e(1), i = e(14), u = e(30), c = u("typed_array"), a = u("view"), f = !(!o.ArrayBuffer || !o.DataView), s = f, l = 0, p = "Int8Array,Uint8Array,Uint8ClampedArray,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array".split(","); l < 9;) {
  ...
  t.exports = function (t, n, e, v, d, y, g) {
    ...
    var m,
      ...
      return function () {
        ...
        P = F || b(d),
        M = d ? E ? b("entries") : P : void 0,
        j = "Array" == n && O.entries || F;

    if (j && (w = s(j.call(new t()))) !== Object.prototype && w.next && (f(w, S, !0), r || "function" == typeof w[l] || u(w, l, h)), E && F && "values" !== F.name && (_ = !0, P = function P() {
      return F.call(this);
    }), r && !g || !p && !_ && O[l] || u(O, l, P), c[n] = P, c[S] = h, d) if (m = {
      values: E ? P : b("values"),
      keys: y ? P : b("keys"),
      entries: M
    }, g) for (x in m) {
  ...
  function L(t, n, e) {
    ...
    for ((t = _(t)) != t || t === S ? (o = t != t ? 1 : 0, r = a) : (r = F(P(t) / M), t * (i = O(2, -r)) < 1 && (r--, i *= 2), (t += r + f >= 1 ? s / i : s * O(2, 1 - f)) * i >= 2 && (r++, i /= 2), r + f >= a ? (o = 0, r = a) : r + f >= 1 ? (o = (t * i - 1) * O(2, n), r += f) : (o = t * O(2, f - 1) * O(2, n), r = 0)); n >= 8; u[l++] = 255 & o, o /= 256, n -= 8) {
      ;
    }
  ...
  function W(t, n, e, r) {
    var o = h(+e);
    if (o + n > t[T]) throw b("Wrong index!");
    var i = t[j]._b,
        u = o + t[A],
        c = i.slice(u, u + n);
  ...
  function V(t, n, e, r, o, i) {
    var u = h(+e);
    if (u + n > t[T]) throw b("Wrong index!");

    for (var c = t[j]._b, a = u + t[A], f = r(+o), s = 0; s < n; s++) {
      c[a + s] = f[i ? s : n - s - 1];
    }
  }
  ...
  if (u.ABV) {
    if (!f(function () {
      ...
      for (var q, G = (_m2 = function m(t) {
        return s(this, _m2), new E(h(t));
      }).prototype = E.prototype, H = v(E), z = 0; H.length > z;) {
        (q = H[z++]) in _m2 || c(_m2, q, E[q]);
      }

      i || (G.constructor = _m2);
    }

    var Y = new _x(new _m2(2)),
        $ = _x.prototype.setInt8;
    Y.setInt8(0, 2147483648), Y.setInt8(1, 2147483649), !Y.getInt8(0) && Y.getInt8(1) || a(_x.prototype, {
  ...
  }, o && (U(_m2, "byteLength", "_l"), U(_x, "buffer", "_b"), U(_x, "byteLength", "_l"), U(_x, "byteOffset", "_o")), a(_x.prototype, {
  ...
  (function (n) {
    ...
    var c,
        a = {
      adapter: (("undefined" != typeof XMLHttpRequest || void 0 !== n) && (c = e(124)), c),
  ...
  var r,
    ...
    try {
      ...
      return (M || "function" == typeof PromiseRejectionEvent) && t.then(j) instanceof n && 0 !== F.indexOf("6.6") && -1 === b.indexOf("Chrome/66");
    } catch (t) {}
  }(),
      L = function L(t) {
    var n;
  ...
  A || (_P = function P(t) {
    v(this, _P, "Promise", "_h"), h(t), r.call(this);
    ...
    Promise: _P
  }), e(39)(_P, "Promise"), e(42)("Promise"), u = e(7).Promise, l(l.S + l.F * !A, "Promise", {
  ...
  t.exports = function (t) {
    return new Promise(function (n, f) {
      ...
      if (p.open(t.method.toUpperCase(), i(t.url, t.params, t.paramsSerializer), !0), p.timeout = t.timeout, p.onreadystatechange = function () {
        ...
        var d = e(328),
            y = (t.withCredentials || c(t.url)) && t.xsrfCookieName ? d.read(t.xsrfCookieName) : void 0;
        y && (l[t.xsrfHeaderName] = y);
      }

      if ("setRequestHeader" in p && r.forEach(l, function (t, n) {
        void 0 === s && "content-type" === n.toLowerCase() ? delete l[n] : p.setRequestHeader(n, t);
  ...
  e(130), t.exports = e(336);
}, function (t, n, e) {
  "use strict";

  e(131);
  var r,
      o = (r = e(303)) && r.__esModule ? r : {
    "default": r
  };
  ...
  var r = e(1),
    ...
    r && delete V[n], A(t, n, e), r && t !== V && A(V, n, r);
      ...
      Y = function Y(t) {
    var n = U[t] = _(_I.prototype);

    return n._k = t, n;
  },
      $ = q && "symbol" == _typeof(_I.iterator) ? function (t) {
    ...
    return !(this === V && o(U, t) && !o(W, t)) && (!(n || !o(this, t) || !o(U, t) || o(this, k) && this[k][t]) || n);
      ...
      Z = function Z(t, n) {
    if (t = b(t), n = S(n, !0), t !== V || !o(U, n) || o(W, n)) {
      var e = T(t, n);
      return !e || !o(U, n) || o(t, k) && t[k][n] || (e.enumerable = !0), e;
    }
  },
      Q = function Q(t) {
    for (var n, e = L(b(t)), r = [], i = 0; e.length > i;) {
    ...
    return r;
      ...
      tt = function tt(t) {
    for (var n, e = t === V, r = L(e ? W : b(t)), i = [], u = 0; r.length > u;) {
      !o(U, n = r[u++]) || e && !o(V, n) || i.push(U[n]);
    }
  ...
  u(u.S + u.F * it, "Object", {
    ...
    stringify: function stringify(t) {
      ...
      if (e = n = r[1], (x(n) || void 0 !== t) && !$(t)) return g(n) || (n = function n(t, _n) {
        if ("function" == typeof e && (_n = e.call(this, t, _n)), !$(_n)) return _n;
      }), r[1] = n, N.apply(R, r);
    }
  }), _I.prototype[C] || e(14)(_I.prototype, C, _I.prototype.valueOf), l(_I, "Symbol"), l(Math, "Math", !0), l(r.JSON, "JSON", !0);
}, function (t, n, e) {
  ...
  if (!_h(" 0o1") || !_h("0b1") || _h("+0x1")) {
    ...
    for (var x, w = e(8) ? f(v) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), b = 0; w.length > b; b++) {
      o(v, x = w[b]) && !o(_h, x) && l(_h, x, s(v, x));
    }
  ...
  e(56)("replace", 2, function (t, n, e, v) {
    return [function (r, o) {
      ...
      for (var w, b = "", S = 0, E = 0; E < m.length; E++) {
        ...
        for (var _ = String(x[0]), O = f(s(u(x.index), p.length), 0), F = [], P = 1; P < x.length; P++) {
        ...
        if (h) {
          var j = [_].concat(F, O, p);
          void 0 !== M && j.push(M);
          var T = String(n.apply(void 0, j));
        } else T = d(_, p, O, F, M, n);

        O >= S && (b += p.slice(S, O) + T, S = O + _.length);
      }
  ...
  e(56)("split", 2, function (t, n, e, s) {
    ...
    return d = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1)[h] || 2 != "ab".split(/(?:ab)*/)[h] || 4 != ".".split(/(.?)(.?)/)[h] || ".".split(/()()/)[h] > 1 || "".split(/.?/)[h] ? function (t, n) {
      ...
      for (var w = 0, b = 0, S = []; b < p.length;) {
        ...
        if (null === _ || (E = l(c(m.lastIndex + (v ? 0 : b)), p.length)) === w) b = u(p, b, y);else {
  ...
  e(289), t.exports = e(62).f("asyncIterator");
}, function (t, n, e) {
  e(91)("asyncIterator");
}, function (t, n, e) {
  ...
  e(112), e(297), t.exports = e(7).Promise["finally"];
}, function (t, n, e) {
  "use strict";
  ...
  for (var r = e(81), o = e(32), i = e(11), u = e(1), c = e(14), a = e(41), f = e(5), s = f("iterator"), l = f("toStringTag"), p = a.Array, h = {
    CSSRuleList: !0,
    ...
    var y,
        ...
        x = u[g],
        w = x && x.prototype;
    if (w && (w[s] || c(w, s, p), w[l] || c(w, l, g), a[g] = p, m)) for (y in r) {
      w[y] || i(w, y, r[y], !0);
    }
  }
}, function (t, n, e) {
  var r = function (t) {
    ...
    return l.prototype = y.constructor = p, p.constructor = l, p[u] = l.displayName = "GeneratorFunction", t.isGeneratorFunction = function (t) {
      ...
      abrupt: function abrupt(t, n) {
        ...
        return u.type = t, u.arg = n, i ? (this.method = "next", this.next = i.finallyLoc, f) : this.complete(u);
      },
  ...
  var r = e(86),
    ...
    for (f in h && (e = n), e) {
      (s = !p && w && void 0 !== w[f]) && c(m, f) || (l = s ? w[f] : e[f], m[f] = h && "function" != typeof w[f] ? e[f] : y && s ? i(l, r) : g && w[f] == l ? function (t) {
  ...
  var e = document.getElementById("jsVideoPlayer"),
      r = document.querySelector("#jsVideoPlayer video"),
      o = document.getElementById("jsPlayBtn"),
      ...
      f = document.getElementById("jsVolume");

  function s() {
    console.log("ch"), r.paused ? (r.play(), o.innerHTML = '<i class="fas fa-pause"></i>', f.value = r.volume) : (f.value = 0, r.pause(), o.innerHTML = '<i class="fas fa-play"></i>');
  }

  function l() {
    e.requestFullscreen ? e.requestFullscreen() : e.mozRequestFullScreen ? e.mozRequestFullScreen() : e.webkitRequestFullscreen ? e.webkitRequestFullscreen() : e.msRequestFullscreen && e.msRequestFullscreen(), u.innerHTML = '<i class="fas fa-compress"></i>', u.removeEventListener("click", l), u.addEventListener("click", p);
  }

  function p() {
    u.innerHTML = '<i class="fas fa-expand"></i>', u.addEventListener("click", l), document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen();
  }
  ...
  function v() {
    c.innerHTML = h(Math.floor(r.currentTime));
  }

  function d() {
    var t = h(r.duration);
    a.innerHTML = t, setInterval(v, 1e3);
  }
  ...
  function g() {
    r.muted ? (r.muted = !1, i.innerHTML = '<i class="fas fa-volume-up"></i>') : (r.muted = !0, i.innerHTML = '<i class="fas fa-volume-mute"></i>');
  }
  ...
  e && (r.volume = .5, o.addEventListener("click", s), i.addEventListener("click", g), u.addEventListener("click", l), r.addEventListener("loadedmetadata", d), r.addEventListener("ended", y), f.addEventListener("input", m));
}, function (t, n) {
  ...
  var o,
      i,
      u = document.getElementById("jsRecordContainer"),
      c = document.getElementById("jsRecordBtn"),
      a = document.getElementById("jsVideoPreview"),
      f = function f(t) {
    var n = t.data,
        e = document.createElement("a");
    e.href = URL.createObjectURL(n), e.download = "recorded.webm", document.body.appendChild(e), e.click(), document.body.removeChild(e);
  },
      s = function t() {
    i.stop(), c.removeEventListener("click", t), c.addEventListener("click", p), c.innerHTML = "Start recording";
  },
      l = function () {
      ...
      return regeneratorRuntime.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            case 0:
              (i = new MediaRecorder(o)).start(), i.addEventListener("dataavailable", f), c.addEventListener("click", s);
      ...
      return regeneratorRuntime.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            ...
            case 3:
              n = t.sent, a.srcObject = n, a.muted = !0, a.play(), c.innerHTML = "Stop recording", o = n, l(), t.next = 16;
              break;

            case 12:
              t.prev = 12, t.t0 = t["catch"](0), console.dir(t.t0), c.innerHTML = "☹️ Cant record";

            case 16:
              return t.prev = 16, c.removeEventListener("click", p), t.finish(16);
  ...
  }, a.Cancel = e(127), a.CancelToken = e(334), a.isCancel = e(126), a.all = function (t) {
    return Promise.all(t);
  }, a.spread = e(335), t.exports = a, t.exports["default"] = a;
}, function (t, n) {
  /*!
  ...
  var u = document.getElementById("jsAddComment"),
      c = document.getElementById("jsCommentList"),
      a = document.getElementById("jsCommentNumber"),
      f = function f(t) {
    var n = document.createElement("li"),
        e = document.createElement("span");
    e.innerHTML = t, n.appendChild(e), c.prepend(n), a.innerHTML = parseInt(a, 10) + 1;
  },
      s = function () {
    var t,
      ...
      return regeneratorRuntime.wrap(function (t) {
        for (;;) {
          switch (t.prev = t.next) {
            case 0:
              return e = window.location.href.split("/videos/")[1], t.next = 3, o()({
    ...
    return function (t) {
      ...
      l = function l(t) {
    t.preventDefault();
    var n = u.querySelector("input"),
        e = n.value;
    s(e), n.value = "";
  };

  u && u.addEventListener("submit", l);
}, function (t, n) {}]);